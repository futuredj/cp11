package su.nightexpress.combatpets.nms.mc_1_21_11.pets.animal;
...
import su.nightexpress.combatpets.nms.mc_1_21_11.goals.combat.PetAutoTargetGoal;
import su.nightexpress.combatpets.nms.mc_1_21_11.goals.combat.PetMeleeAttackGoal;
import su.nightexpress.combatpets.nms.mc_1_21_11.goals.follow.PetFollowOwnerGoal;
...
public class FoxPet extends Fox implements PetEntity {
    ...
    private static final Method SET_FACEPLANTED = Reflex.safeMethod(Fox.class, "setFaceplanted", "B", boolean.class);
    private static final Method CLEAR_STATES    = Reflex.safeMethod(Fox.class, "clearStates", "gY");
    ...
    private static class FoxFloatGoal extends FloatGoal {
        ...
        public void start() {
            super.start();
            Reflex.invokeMethod(CLEAR_STATES, this.pet);
        }
    ...
    private static class FoxStalkPreyGoal extends Goal {
        ...
        public void start() {
            ...
            Reflex.invokeMethod(SET_FACEPLANTED, this.pet, false);
        }
